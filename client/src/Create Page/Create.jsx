...
const Create = () => {
  ...
  return (
    <div className="m-auto flex justify-center w-1/3" >
      <form
        onSubmit={handleSubmit}
        className="flex  flex-col w-full mt-2  border border-gray-300 rounded-lg p-3 text-center"
        style={create}
      >
        ...
        <div className="flex justify-between" >
          <div className="mb-2 w-1/5 ">
            <label htmlFor="yearMade" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Year :</label>
            <input
              type="text"
              id="yearMade"
              name="yearMade"
        ...
        <div className=" flex justify-evenly">
          <div className="w-2/5" >
            <div className="mb-2">
              <label htmlFor="horsePower" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Horsepower:</label>
              <input
                type="number"
                id="horsePower"
                name="horsePower"
            ...
            <div className="mb-2">
              <label htmlFor="maxSpeed" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Price :</label>
              <input
                type="number"
                id="maxSpeed"
                name="Price"
...
<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded w-1/3 ">
  Button
</button>  
</div>
